...
%steady state
[Y_obs, s_true] = DSGE_simulate(theta, 50, 100);     %Practive 2.a : 50 대신 10 20 30 50 

%run the filter/smoother on Y(:,1:3)
Sigma_u = zeros(4);
alpha = .1;
[s_mean, P_mean, s_hi, s_lo, L] = kalman_wrapper(theta,Y_obs(:,1:3),alpha, Sigma_u);     %Practive 2.b : Y_obs(:,2:4)
