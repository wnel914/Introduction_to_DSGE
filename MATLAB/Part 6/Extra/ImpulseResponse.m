...
nend        = 6;  % Number of Endogenous Variables
...
for i=1:Nsim
    ...
    B            = [B1;[0,0,1,zeros(1,9),1];[zeros(1,6),1,zeros(1,5),1];... % Select Output, Hours, Consumption, Investment, Wages
...
for j=1:6
    ...
    subplot(3,2,j), plot(median(IRF_tech(:,:,j),2)*100,'LineWidth',3), hold on
...
for j=1:6
    ...
    subplot(3,2,j), plot(median(IRF_pref(:,:,j),2)*100,'LineWidth',3), hold on
